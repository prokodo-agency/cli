      ...
      <div className="container">
        ...
        <div className={clsx(styles.heroCtas, 'prokodo-docs--hero-cta')}>
          ...
          <Button
            ...
            variant="outlined"
            title={translate({
              id: 'prokodo.homepage.hero.commandReference',
  ...
  return (
    <Layout
      ...
      description={translate({
        ...
        message:
          'Official documentation for the prokodo CLI. Verify, inspect, and manage your prokodo projects from the terminal.',
      })}
    >
      <HeroSection />
            ...
            <div className={styles.codeStrip}>
              ...
              <DocLink to="/docs/commands/auth" className={styles.codeStep}>
                <div className={styles.stepHeader}>
                  ...
                  <span className={styles.stepLabel}>
                    <Translate id="prokodo.homepage.quickstart.step.authenticate">
                      Authenticate
                    </Translate>
                  </span>
                </div>
