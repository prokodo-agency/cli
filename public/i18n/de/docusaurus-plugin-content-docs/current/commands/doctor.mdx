...
keywords: [prokodo doctor, prokodo Diagnose, prokodo Umgebungscheck, prokodo doctor Befehl, prokodo Debug]
---
...
```json
{
  "checks": [
    ...
    { "name": "API-Schlüssel konfiguriert", "status": "pass", "detail": "Quelle: credentials.json" },
