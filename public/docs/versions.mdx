...
<Admonition type="info" title="Breaking changes">
  Any breaking changes are clearly marked in the [Changelog](./changelog) and the major version is bumped.
  Check the changelog before upgrading across major versions.
</Admonition>
